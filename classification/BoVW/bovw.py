...
def bovw(address, original_class):
    ...
    for i in range(32):
        ...
        count_cluster[i]=len(y_means[y_means==i])
...
load("Image_Group09/train","patch")
load("Image_Group09/test","patch")
# Initialise and train the model
kmeans = KMeans(n_clusters=32)
kmeans.fit(final_hist)
# load images and create patches and predict clusters
load("Image_Group09/train","image")
load("Image_Group09/test","image")
