...
y1 = 0*np.ones(len(df1.index))
#Storing true values for class2 in y2
y2 = 1*np.ones(len(df2.index))
#Storing true values for class3 in y3
y3 = 2*np.ones(len(df3.index))
...
# decision plot for seond perceptron with training data
...
print("Accuracy for validation data: ", accuracy_val)